...
void AppLauncher::onLauncherOpen()
{
    ...
    // StackChan v10.10.7: al volver al launcher (home / fin de chat), apagar LEDs.
    // set_leds_off() ahora cancela también la animación del NeonLight
    // (turnOff -> teleport negro), que era lo que repintaba azul por encima
    // del showRgbColor(0,0,0) de la v10.10.6.
