...
void reset_xiaozhi_ui_flags();
void set_leds_off();
void reset_xiaozhi_ui_flags();
// StackChan v10.9.7: color manual persistido (tool set_led_color del LLM).
// Se mantiene tras desconectar (estilo IA china). -1 = sin manual.
