...
private:
    ...
    // StackChan v10.9.6: handle de la task de audio para poder matarla en el
    // destructor ANTES de borrar el event group (evita Interrupt WDT panic
    // al volver del chat al launcher).
